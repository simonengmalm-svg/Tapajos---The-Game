...
// Charmiga & tokiga anekdoter per hustyp
const ANEKD = {
  landsh: [
    "Gamla vedspisen i lägenheten blev kult – nu lagar alla i trappan söndagsmiddag tillsammans.",
    "Trapphuset målades i pastellfärger av en lokal konstnär – grannarna håller konstvisningar.",
    "Ett gammalt vindsförråd förvandlades till hemligt jazzhak.",
    "Katterna i huset har gemensam julfest varje år (ja, någon gör små möss-maträtter).",
    "En hyresgäst satte upp fågelholkar – det blev kö för att titta på talgoxarnas ungar.",
    "En försvunnen källarnyckel hittades i en syltburk bakom murstocken.",
    "Barnen ordnade luciatåg genom hela huset – till och med hyresvärden fick en lussekatt.",
    "En hyresgäst installerade en brevduva för aviseringar. Det fungerar förvånansvärt bra.",
    "Grannarna håller årlig surströmmingsfest på gården, till både glädje och skräck.",
    "Den gamla tvättstugan har fler historier än någon kan minnas – och märkliga dofter."
  ],
  funkis: [
    "Någon satte igång med spontandans i trapphuset – och hela huset hakade på.",
    "Takterrassen användes som bioduk – grannbio varje lördag.",
    "Husets gemensamma bastu kallas nu 'FN-salen' – alla konflikter löses där.",
    "En hyresgäst började odla chili i tvättstugan. Det blev en lokal specialitet.",
    "En av balkongerna är nu officiellt ett miniatyrmuseum.",
    "Trapphuset luktar alltid kanel på fredagar. Ingen vet varför.",
    "Någon satte in ett piano i hissen – det blev hisskonserter.",
    "Varje nyinflyttad får en blomma från 'den hemliga blomgruppen'.",
    "En grannes papegoja började ropa 'KAFFEPAUS!' varje morgon kl 07:00.",
    "En spontan julmarknad i källaren lockade hela kvarteret."
  ],
  miljon: [
    "Källaren användes till inomhusfotboll – målburar av tvättkorgar.",
    "Grannarna organiserade egen pizzeria i tvättstugan – kvällsöppet fredagar.",
    "Barnen byggde ett hemligt fort i sopnedkastet (det varade två dagar).",
    "En hyresgäst förvandlade balkongen till tropiskt paradis med plastpapegojor.",
    "Kvarterets största grillfest – 200 korvar på en gång – hölls på innergården.",
    "Ett block i området började med karaoke på tisdagar – det hörs tre kvarter bort.",
    "En av portarna är känd för sin hemliga graffitivägg.",
    "Cykelrummet blev en träningslokal med skivstänger och boxningssäck.",
    "Husets tvättschema ersattes av 'rock, paper, scissors'.",
    "Hissen spelar nu alltid dansband, tack vare en teknisk granne."
  ],
  nyprod: [
    "Alla försökte programmera om de smarta låsen – resultatet: ingen kom in på en vecka.",
    "Grannarna tävlade i vem som hade mest stilren inredning – en inredningsblogg föddes.",
    "Det första snöbollskriget på gården sändes live på Instagram.",
    "En granne körde VR-disco i vardagsrummet – hela huset dansade med via fönstren.",
    "Laddstolparna används också för att ladda elgräsklippare och elsparkcyklar.",
    "Gården har en robotgräsklippare som barnen döpt till 'R2-Mow2'.",
    "Alla hushåll fick fel namn på dörrskyltarna vid inflytt – och det blev en farsartad sitcom.",
    "En granne satte upp biodling på taket – honungen säljs nu under namnet 'BRF-guld'.",
    "Smartlamporna blinkade i takt – huset deltog i Eurovision med ljusshow.",
    "Sopnedkastet spelar jinglar när man slänger plast."
  ],
  gamlastan: [
    "En av källarvalven visade sig vara en gammal smugglargång.",
    "Husets äldsta hyresgäst berättar spökhistorier vid strömavbrott.",
    "Fönstren pyntas alltid med ljuslyktor – turister tror att det är en sevärdhet.",
    "En hyresgäst lärde en kråka säga 'välkommen hem'.",
    "Portgången användes för improviserade konserter med fiol och dragspel.",
    "Någon bakar alltid bröd i vedugnen – hela kvarteret luktar gott.",
    "Ett gammalt brev från 1800-talet hittades under golvplankorna.",
    "Barnen tror att vinden är hem åt 'spöket Margareta'.",
    "Grannarna har årlig kostymbal i innergården.",
    "En italiensk turist flyttade nästan in av misstag – 'det kändes som hemma'."
  ]
};
